...
class Page {
    ...
    protected $config  =    array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>'第一页','last'=>'最后页','theme'=>"共 %totalRow% %header% %first% %upPage% %linkPage%  %downPage%  %end%第 %nowPage%/%totalPage% 页");
    // 默认分页变量名
    protected $varPage;
